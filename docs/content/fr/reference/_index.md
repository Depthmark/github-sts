---
title: Référence
description: Contrats techniques stables et complets pour l'API, la configuration, les variables d'environnement et les métriques de github-sts.
weight: 3
...
{{< cards >}}
{{< card link="api" title="Référence API" icon="terminal" subtitle="Points de terminaison HTTP, méthodes, paramètres, réponses, codes d'erreur et exemples client Go" >}}
