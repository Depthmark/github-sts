...
The [Quickstart (local)](quickstart-local/) runs github-sts on your own machine with settings chosen for setup speed. For a real deployment, see [the Helm chart quickstart]({{< relref "/integrations/helm-chart/quickstart" >}}) and [Kubernetes](../operations/kubernetes/).
